...
│           │                   #      Holdings carries a Grand Total (unrealised, whole scope not the page)
...
│   │   ├── summary-rows.ts     #   Row classification, both filter bars and the option-register
│   │   │                       #   derivation — shared by the desk console and the client portal,
│   │   │                       #   so the same row cannot land under two headings (+ 14 tests)
