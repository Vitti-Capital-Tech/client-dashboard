    ...
    <div className="space-y-4 text-ink font-body select-none">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="card bg-white border border-line rounded-[14px] p-4.5 shadow-shadow">
          ...
          <div className="font-disp font-medium text-2xl mt-1 text-ink">{clientCount} verified</div>
      ...
      <div className="card bg-white border border-line rounded-[14px] p-4.5 shadow-shadow space-y-3">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {placements.filter(p => p.stage !== "upcoming").map(p => {
              ...
              <tbody className="divide-y divide-[#f0ede5]">
                {registerRows.map(r => (
                  ...
                  >
                    ...
                    <td className="px-4.5 py-3 text-mut">{r.accountType}</td>
                    <td className="px-4.5 py-3 text-right font-mono text-[13px]">${Math.round(r.value).toLocaleString("en-AU")}</td>
                    ...
                    <td className="px-4.5 py-3 text-right text-mut font-mono">{r.s708}</td>
                  </tr>
                ))}
              </tbody>
            </table>
