  ...
  public: {
    Tables: {
      account_merge_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "account_merge_requests_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "account_merge_requests_source_account_id_fkey"
          ...
          {
            foreignKeyName: "account_merge_requests_target_account_id_fkey"
      ...
      option_holdings: {
        ...
        Relationships: [
          {
            foreignKeyName: "option_holdings_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
      ...
      realized_pnl: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "realized_pnl_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
      ...
      trades: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "trades_parent_code_fkey"
            columns: ["parent_code"]
            isOneToOne: false
            referencedRelation: "securities"
            referencedColumns: ["code"]
          ...
          {
            foreignKeyName: "trades_security_code_fkey"
            columns: ["security_code"]
            isOneToOne: false
            referencedRelation: "securities"
            referencedColumns: ["code"]
